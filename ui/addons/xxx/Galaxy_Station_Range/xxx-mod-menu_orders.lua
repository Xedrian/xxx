...
function Funcs.yvgstr_displayMenu()
	...
	local selectdesc = setup:createCustomWidthTable({ Helper.standardTextHeight, Helper.standardTextHeight, 0, 500 }, false, false, true, 1, 0, 0, Helper.tableCharacterOffsety, 450, false, menu.toprow, menu.selectrow)
	menu.toprow = nil
	menu.selectrow = nil
